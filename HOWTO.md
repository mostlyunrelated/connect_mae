# Welcome to Connect Extension project MAA31TEST

## Next steps

You may open your favourite IDE and start working with your project, please note that this project runs using docker.
You may modify at any time the credentials used to authenticate to connect modifying the file *maa31test/.maa31test_dev.env*.
...
```sh
$ docker compose up maa31test_dev
```
...
```sh
$ docker compose run maa31test_bash
```
...
```sh
$ docker compose run maa31test_test
```
